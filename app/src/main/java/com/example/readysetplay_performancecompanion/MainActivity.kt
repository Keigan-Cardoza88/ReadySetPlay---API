...
class MainActivity : AppCompatActivity() {
    ...
    private var scrollSpeed = 5 // Default scroll speed (px)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textInputLayout = findViewById(R.id.textInputLayout)  // From XML
        searchInput = findViewById(R.id.searchInput)
        ...
        aiAutoScrollButton.text = "AI Scroll"
        ...
        // TextWatcher to show "Go" button when typing
        searchInput.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
                // Show the "Go" button if there is text in the input field
        ...
        searchInput.setOnFocusChangeListener { _, hasFocus ->
            if (hasFocus || searchInput.text?.isNotEmpty() == true) {
        ...
        // Continue with other button listeners...
    ...
    private fun updateAutoScrollButtonText() {
        if (isAutoScrolling) {
            autoScrollButton.text = "🚫 Scroll ($scrollSpeed)"
        } else {
